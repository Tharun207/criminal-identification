...
def basicPageSetup(pageNo):
    ...
    back_img = tk.PhotoImage(file="G:\project\project1\Criminal-Identification-System-master-master\Criminal-Identification-System-master\\back.png")
...
def selectMultiImage(opt_menu, menu_var):
    ...
    if(len(path_list) < 5):
        ...
        back_img = tk.PhotoImage(file="G:\project\project1\Criminal-Identification-System-master-master\Criminal-Identification-System-master\\previous.png")
        next_img = tk.PhotoImage(file="G:\project\project1\Criminal-Identification-System-master-master\Criminal-Identification-System-master\\next.png")
...
logo = tk.PhotoImage(file = "G:\project\project1\Criminal-Identification-System-master-master\Criminal-Identification-System-master\\logo.png")
