...
def insertData(data):
    ...
    #query= "INSERT INTO `criminaldata`(`id`, `name`, `father name`, `mother name`, `gender`, `dob`, `blood group`, `identity mark`, `nationality`, `religion`, `crimes`) VALUES ('[value-1]','[value-2]','[value-3]','[value-4]','[value-5]','[value-6]','[value-7]','[value-8]','[value-9]','[value-10]','[value-11]')"
